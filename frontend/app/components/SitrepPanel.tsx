...
export default function SitrepPanel({ selectedAlarm, onAcknowledge }: SitrepPanelProps) {
    return (
        <section className="flex-1 glass rounded-2xl border-[rgba(7,242,219,0.12)] flex flex-col relative overflow-hidden">
                    ...
                    >
                        <div className="flex justify-between items-start mb-8">
                            <div>
                                <div className="flex items-center gap-2 mb-1">
                                    ...
                                    <span className="text-white/40 text-xs">{selectedAlarm.id}</span>
                            ...
                            {selectedAlarm.ackState !== 'acknowledged' && (
                                <button
                                    ...
                                    className="px-6 py-2.5 bg-cyan-400 hover:bg-cyan-300 text-gray-950 rounded-lg font-bold transition-all duration-200 glow active:scale-95 shadow-lg"
                                >
                                    Acknowledge Alarm
                                </button>
                            )}
                        ...
                        <div className="grid grid-cols-2 gap-8 flex-1 content-start">
                            <div className="space-y-6">
                                ...
                                <div className="prose prose-invert max-w-none text-white/80 bg-[#06203b]/60 p-6 rounded-xl border border-[rgba(7,242,219,0.08)] leading-relaxed shadow-inner">
                            ...
                            <div className="space-y-6">
                                <h3 className="text-white/40 text-xs font-black uppercase tracking-widest">Validation & Feedback</h3>
                                <FeedbackWidget
                                    decisionId={selectedAlarm.decisionId || selectedAlarm.id}
                                    onFeedbackSubmitted={() => console.log('Feedback received')}
                                />

                                <div className="bg-[#06203b]/40 border border-[rgba(7,242,219,0.08)] rounded-xl p-6">
