---
# 1. Document Identity
title: "pedk.ai - AI-native operational reconciliation engine"
subtitle: "Financial Market Infrastructure Edition --- Version 2.1"
...
# 2. Layout, Font Sizes, and Engine Settings (Tightened for Page Control)
fontsize: 11pt
geometry: 
  - top=2cm
  - bottom=2cm
...
# 3. Header & Footer Text (Native Pandoc Configuration Strings)
...
# 5. Advanced Typography Injection
header-includes: |
  \usepackage{silence}
  \WarningFilter{ulem}{Command \underbar has changed}
  \WarningFilter{ulem}{Command \underline has changed}
  ...
  \sectionfont{\fontsize{16}{20}\selectfont\rmfamily\bfseries}
  \subsectionfont{\fontsize{13}{16}\selectfont\rmfamily\bfseries}
  \subsubsectionfont{\fontsize{11}{14}\selectfont\rmfamily\bfseries}

  \usepackage{enumitem}
  \setlist[itemize]{font=\normalsize, label=$\bullet$, noitemsep, topsep=2pt, parsep=0pt}
  \setlist[enumerate]{font=\normalsize, noitemsep, topsep=2pt, parsep=0pt}

  \addtokomafont{title}{\fontsize{30}{35}\selectfont\rmfamily\bfseries}
  \addtokomafont{author}{\fontsize{20}{22}\selectfont\rmfamily}
  \addtokomafont{date}{\fontsize{16}{16}\selectfont\rmfamily}
