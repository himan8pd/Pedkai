...
date: |
  \fontsize{16}{16}\selectfont 09-Mar-2026
...
monofont: "JetBrainsMono-Regular.otf"
monofontoptions:
  - "Path=/usr/local/texlive/2026/texmf-dist/fonts/opentype/SIL/jetbrainsmono-otf/"
  - "BoldFont=JetBrainsMono-Bold.otf"
  - "ItalicFont=JetBrainsMono-Italic.otf"
  - "BoldItalicFont=JetBrainsMono-BoldItalic.otf"
header-includes: |
  \makeatletter
...
**Supersedes:** All root-level vision, roadmap, review, and strategy documents (see [§18 Document Catalogue](#18-document-catalogue))
...
|  - OPERATOR ALWAYS IN CONTROL (see S7)                           |
+------------------------------------------------------------------+
...
|  - Root Cause Analysis (graph-based causal inference -- S8)      |
|  - LLM Reasoning (vendor-neutral -- see S15)                     |
|  - Decision Similarity Search (vector embeddings)                |
|  - Evidence Fusion (pluggable methodology -- see S5)             |
+------------------------------------------------------------------+
...
|  - ABEYANCE MEMORY -- Pedk.ai's core differentiator (see S4)     |
|  - Topological Ghost Masks (suppress alarms during maintenance)  |
+------------------------------------------------------------------+
|  Layer 1: Omniscient Data Fabric                                 |
|  - Physical Reality: Telemetry (Kafka), PM counters, logs        |
|  - Bureaucratic Intent: ITSM tickets, CMDB exports, changes      |
...
$$P(\text{hypothesis} \mid \text{evidence}_1, \text{evidence}_2, \ldots, \text{evidence}_n) = 1 - \prod_{i}(1 - p_i)$$
